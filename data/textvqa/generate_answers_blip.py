...
def eval_model(args):
    ...
    for line in tqdm(questions, total=len(questions)):
        ...
        if args.query_formatter and args.query_formatter != "":
            line['text_input'] = args.query_formatter.format(line['text']) 
        else:
            line['text_input'] = line['text']
...
if __name__ == "__main__":
    ...
    parser.add_argument("--question-file", type=str, default="datasets/vqav2/coco2014val_questions.jsonl")
