...
class CustomDataset(Dataset):
    def __init__(self, questions, image_folder, tokenizer, image_processor, model_config, image_ext='pt', query_formatter="{}\nAnswer the question using a single word or phrase."):
...
def create_data_loader(questions, image_folder, tokenizer, image_processor, model_config, batch_size=1, num_workers=4, image_ext='pt'):
    ...
    dataset = CustomDataset(questions, image_folder, tokenizer, image_processor, model_config, image_ext=image_ext)
