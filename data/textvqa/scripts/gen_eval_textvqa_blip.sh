...
# image_folder="/groups/sernam/datasets/vqa/scienceqa/test"
params="default"
...
for model in  "blip2_vicuna_instruct,vicuna13b"; do
    ...
    for attack in "CW,289527"  ; do
        ...
        image_folder="/groups/sernam/adv_llava/adv_datasets/textvqa/retrieval/${attack_name}/blip2_attack_params:${params}_${dataset_id}"
        # image_folder="/groups/sernam/datasets/vqa/textvqa/train_images"
        export log_file="/groups/sernam/adv_llava/results/logs/textvqa/vqa/${attack_name}/adv${dataset_id}_${params}_${model_path}_${model_type}_ID:${SLURM_JOB_ID}.log"
        exec &> $log_file
        ...
        ~/anaconda3/envs/adv_env/bin/python3.9 -m textvqa.generate_answers_blip \
            ...
            --result-file /groups/sernam/adv_llava/results/responses/textvqa/${attack_name}/adv${dataset_id}_${params}_${model_path}_${model_type}_ID:${SLURM_JOB_ID}.jsonl \
            --image_ext pt \
