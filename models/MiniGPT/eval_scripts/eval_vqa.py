...
from models.MiniGPT.minigpt4.datasets.datasets.vqa_datasets import OKVQAEvalData,VizWizEvalData,IconQAEvalData,GQAEvalData,VSREvalData,HMEvalData
...
from models.MiniGPT.minigpt4.common.eval_utils import prepare_texts, init_model, eval_parser
